...
function testStatusProgressBar_OpeningFcn(hObject, ~, handles, varargin)
...
function varargout = testStatusProgressBar_OutputFcn(~, ~, handles) 
...
function pushbuttonStart_Callback(hObject, ~, handles) %#ok<DEFNU>
...
function pushbuttonNextStep_Callback(hObject, ~, handles) %#ok<DEFNU>
